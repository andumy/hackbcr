...
Route::group(['middleware' => ['auth','2fa']], function () {
	...
	Route::get('feedback/delete_get/{feedback}','FeedbackController@delete_get');
	Route::get('feedback/display_sent','FeedbackController@display_sent')->name('feedback.display_sent');
