...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('This is your profile page. You can edit your contact data.'),
        'class' => 'col-lg-7'
    ])   
                ...
                <div class="card card-profile shadow">
                    <div class="row justify-content-center">
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image">
                                <a href="#">
                                    <img src="{{ Auth::user()->getAvatar(256) }}" class="rounded-circle">
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        ...
                        <div class="text-center">
                            <h3>
                                {{ auth()->user()->first_name }} {{ auth()->user()->last_name }}<span class="font-weight-light"></span>
                            </h3>
                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('profile.update') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('first_name') ? ' has-danger' : '' }}">
                                    <input
                                        ...
                                        placeholder="{{ __('First Name') }}" value="{{ old('first_name', auth()->user()->first_name) }}" required
                                    >
                                ...
                                <div class="form-group{{ $errors->has('last_name') ? ' has-danger' : '' }}">
                                    <input
                                        ...
                                        placeholder="{{ __('Last Name') }}" value="{{ old('last_name', auth()->user()->last_name) }}" required
                                    >
                            ...
                            <h6 class="heading-small text-muted mb-4">{{ __('Team Management') }}</h6>
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    >
                                        ...
                                        @foreach ($departments as $department)
                                            <option
                                                value="{{ $department->id  }}"
                                                @if(old('department_id', auth()->user()->department_id) === $department->id)
                                                selected
                                                @endif
                                            >
                                                {{ $department->name  }}
